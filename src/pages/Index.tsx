...
const Index = () => {
    ...
    const handleSubscribe = async () => {
        // Add the email to db.json through an API call
        const newUser = {
            id: new Date().toISOString(), // or generate a unique ID
            email: email
        };

        // Assuming you're using fetch to make a POST request to your API
